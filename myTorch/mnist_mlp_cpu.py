...
from myTorch.layers import FullyConnectLayer, ReLULayer, SoftmaxLayer

MNIST_DIR = "../mnist_data"
TRAIN_DATA = "train-images-idx3"
TRAIN_LABEL = "train"
TEST_DATA = ""
TEST_LABEL = ""
...
class MinistMlp:
    ...
    def build_model(self):
        ...
        self.fc3 = FullyConnectLayer(self.hidden2, self.hidden3)
        self.relu3 = ReLULayer()
        self.fc4 = FullyConnectLayer(self.hidden3, self.out_classes)
...
def build_mnist_mlp(param_dir="weight.npy"):
    ...
    mlp = MinistMlp(hidden1=h1, hidden2=h2, hidden3=h3, max_epoch=e)
    mlp.load_data()
    mlp.build_model()
    mlp.init_model()
    mlp.train()
